              ...
              >
                ...
                >
                  <motion.div
                    ...
                    className="w-20 h-20 rounded-full bg-white/95 dark:bg-gray-800/95 flex items-center justify-center shadow-[0_4px_30px_rgb(var(--brand-shadow)/0.18),inset_0_0_0_1px_rgb(var(--brand-shadow)/0.18)]"
