      ...
      <div className="flex gap-1.5 items-center py-1.5 px-1">
        <span
          className={cn(
            ...
            isTeacher ? 'bg-primary/10 dark:bg-primary/10' : 'bg-primary/10 dark:bg-primary/10',
          )}
        />
        <span
          className={cn(
  ...
  return (
    <div
      className={cn(
        ...
        isUser
          ? 'bg-gradient-to-br from-primary to-accent dark:from-primary dark:to-accent text-white rounded-tr-sm shadow-[0_10px_22px_-16px_rgb(var(--brand-shadow)/0.46)] ring-1 ring-primary/25'
          : isTeacher
            ...
            : 'bg-primary/10 dark:bg-primary/10 text-primary dark:text-primary border border-primary/25 dark:border-primary/25 rounded-tl-sm',
      )}
    >
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isActiveBubble &&
                  'border-l-primary dark:border-l-primary bg-primary/10 dark:bg-primary/10',
              )}
            >
              {/* Mini Avatar */}
          ...
          >
            ...
            {isSoftClosing && onContinueSession && (
              <button
                ...
                className="h-7 bg-white dark:bg-gray-800 text-primary dark:text-primary border border-primary/25 dark:border-primary/25 px-2.5 rounded-md text-[11px] font-semibold flex items-center gap-1.5 transition-colors hover:bg-primary/10 dark:hover:bg-primary/10"
              >
