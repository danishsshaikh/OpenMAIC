    ...
    <div className="flex items-center gap-2" onClick={onExpand}>
      <div
        className={cn(
          ...
          bubble.role === 'user'
            ? 'bg-primary/10 dark:bg-primary/10 border-primary/25 dark:border-primary/25'
            : bubble.role === 'agent'
      ...
      {onPlayPause && (
        <div
          ...
          className={cn(
            ...
            'hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]',
            bubble.role === 'user'
              ? 'bg-primary/10 dark:bg-primary/10 border-primary/25 dark:border-primary/25 hover:bg-primary/10 dark:hover:bg-primary/10'
              : bubble.role === 'agent'
          ...
          if (buttonState === 'play') {
            return (
              <div
                ...
                className="absolute right-2.5 bottom-2.5 z-20 p-1.5 rounded-full bg-white/40 dark:bg-gray-800/40 backdrop-blur-sm group-hover/bubble:bg-primary/10 dark:group-hover/bubble:bg-primary/10 transition-all duration-300 cursor-pointer"
              >
                <Play className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 group-hover/bubble:text-primary dark:group-hover/bubble:text-primary ml-0.5" />
              </div>
            );
          }
          ...
          if (buttonState === 'restart') {
            return (
              <div
                ...
                className="absolute right-2.5 bottom-2.5 z-20 p-1.5 rounded-full bg-white/40 dark:bg-gray-800/40 backdrop-blur-sm group-hover/bubble:bg-primary/10 dark:group-hover/bubble:bg-primary/10 transition-all duration-300 cursor-pointer"
              >
                <Repeat className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 group-hover/bubble:text-primary dark:group-hover/bubble:text-primary" />
              </div>
            );
          }
