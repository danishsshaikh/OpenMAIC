      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute inset-4 pointer-events-auto bg-white/95 dark:bg-gray-800/95 backdrop-blur-2xl rounded-3xl shadow-[0_32px_80px_-20px_rgba(0,0,0,0.25)] border-2 border-primary/20 flex flex-col overflow-hidden z-[120] ring-4 ring-primary/10"
          >
            {/* Header */}
