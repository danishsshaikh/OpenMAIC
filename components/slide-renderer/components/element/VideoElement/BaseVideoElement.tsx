    ...
    >
      ...
      >
        {showDisabled ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-secondary via-background to-accent/10 dark:from-secondary dark:via-background dark:to-accent/10 flex items-center justify-center rounded">
            <style>{`
            ...
            <div className="relative w-14 h-14">
              ...
              />
              <Film className="absolute inset-0 m-auto w-5 h-5 text-primary/75" strokeWidth={1.5} />
            </div>
          </div>
        ) : showError ? (
