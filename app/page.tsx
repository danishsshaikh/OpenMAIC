  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const requirements: UserRequirements = {
        ...
        interactiveMode: interactiveScenesEnabled
      ...
      >
        ...
        >
          ...
          {workbenchEntryEnabled ? (
            <div className="mt-4" data-pro-morph="badge">
        ...
        >
          <div
            ...
            className="w-full overflow-hidden rounded-lg border border-border bg-card/95 shadow-[0_28px_76px_-54px_rgb(var(--brand-shadow))] backdrop-blur-xl transition-shadow focus-within:border-primary/40 focus-within:shadow-[0_34px_90px_-56px_rgb(var(--brand-shadow))] dark:shadow-none"
          >
