...
import { englishOnlyDeployment } from './deployment';
...
i18n
  ...
  .init({
    lng: defaultLocale,
    fallbackLng: englishOnlyDeployment.fallbackLocale,
    supportedLngs: englishOnlyDeployment.exposedLocales.map((l) => l.code),
    interpolation: {
      escapeValue: false,
    },
  });
